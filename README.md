...
This scenario was generated by combining Sybil and Bias Injection attack. We use the strategic attacker model. As can be seen the injection of the attacks results in accidents when we compare against the framework in (Sabbir et al., [2023](https://arxiv.org/abs/2305.16818))
