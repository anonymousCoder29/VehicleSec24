...
This scenario was generated by combining Sybil and Bias Injection attack. We use the strategic attacker model. As can be seen the injection of the attacks results in accidents when we compare against the framework in (Sabbir et al., [2023]([https://doi.org/10.1109/MCI.2018.2840738](https://arxiv.org/abs/2305.16818))) (Young et al., [2018](https://doi.org/10.1109/MCI.2018.2840738))
